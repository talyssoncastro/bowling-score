...
public class SparePrinterConsole implements PrinterConsole {
    ...
    public String print(Frame frame) {
        return frame.shot1Optional().get().getRepresentation() + separatorConfiguration.get() + "/" + separatorConfiguration.get();
    }
}

...
public class PerfectScoreOutputTests {
    ...
    public void test() throws IOException {
        ...
        File inputFile = new ClassPathResource("perfect_score/input.txt").getFile();

        File resultFile = new ClassPathResource("perfect_score/result.txt").getFile();

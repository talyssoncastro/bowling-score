...
public class Player1OutputTests {
    ...
    public void test() throws IOException {
        ...
        File inputFile = new ClassPathResource("player1/input.txt").getFile();

        File resultFile = new ClassPathResource("player1/result.txt").getFile();

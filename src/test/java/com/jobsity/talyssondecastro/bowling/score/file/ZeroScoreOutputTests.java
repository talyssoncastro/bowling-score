...
public class ZeroScoreOutputTests {
    ...
    public void test() throws IOException {
        ...
        File inputFile = new ClassPathResource("zero_score/input.txt").getFile();

        File resultFile = new ClassPathResource("zero_score/result.txt").getFile();
